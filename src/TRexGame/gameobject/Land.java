...
public class Land {
    ...
    public Land(int width, MainCharacter mainCharacter) {
        ...
        land1 = Resource.getResouceImage("src/TRexGame/data/land1.png");
        land2 = Resource.getResouceImage("src/TRexGame/data/land2.png");
        land3 = Resource.getResouceImage("src/TRexGame/data/land3.png");
